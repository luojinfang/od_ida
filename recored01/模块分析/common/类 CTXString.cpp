...
----                                             -------  -------
CTXStringW::CTXStringW(_GUID const &)            523F5FF0 117    
CTXStringW::CTXStringW(tagVARIANT const &)       523F63D0 118    
CTXStringW::CTXStringW(CTXStringW const &)       523F1870 119    
CTXStringW::CTXStringW(CTXBSTR const &)          523F1870 120    
CTXStringW::CTXStringW(int)                      523F16B0 121    
CTXStringW::CTXStringW(wchar_t *)                523F6080 122    
CTXStringW::CTXStringW(wchar_t const *)          523F1750 123    
CTXStringW::CTXStringW(wchar_t const *,int)      523F5E70 124    
CTXStringW::CTXStringW(tagEN,char const *,int)   523F61B0 125    
CTXStringW::CTXStringW(tagGBK,char const *,int)  523F6170 126    
CTXStringW::CTXStringW(tagUTF8,char const *,int) 523F60F0 127    
CTXStringW::CTXStringW(void)                     522E3C30 128    
CTXStringW::CTXStringW(wchar_t,int)              523F5F60 129       


//CTXStringW 带20字节头部数据 
//CTXStringW[20], (DWORD)为字符串内存地址; dump ecx+14  和 CTXBSTR 一样

CTXStringW[16]  (_DWORD),字符串长度
...
//====================================================================================================================================================
//CTXStringW::CTXStringW(int)                      523F16B0 121    
 _DWORD *__thiscall CTXStringW::CTXStringW(_DWORD *this, int a2)
{
  _DWORD *v2; // edi@1
  struct CTxStringMgr *v3; // eax@1
  int v5; // eax@4

  v2 = this;
  v3 = TxGetDefaultStringManager(); //------------>
  if ( a2 )
  {
    v5 = sub_523F4FD0(a2, 2, 0, 0, 0, 0); //------------>
    *v2 = v5 + 20; //CTXBSTR 带20字节头部数据 
    if ( a2 < 0 || a2 > *(_DWORD *)(v5 + 12) >> 1 >> 1 )
      sub_522AF120(-2147024809);
    *(_DWORD *)(v5 + 16) = 2 * a2; //实际大小值存在头部
    *(_WORD *)(*v2 + 2 * a2) = 0;//结束符
  }
  else
  {
    *v2 = (char *)v3 + 20;
    if ( v3 != (struct CTxStringMgr *)dword_52528F6C )
    {
...
LONG __thiscall sub_523F5C30(int *this, void *Src, int a3)
{
  ...
  if ( a3 )
  {
    ...
    v10 = 2 * v3; 
    if ( v11 > v7 )
      memcpy(v8, Src, v10); //复制
    else
      memmove(v8, (char *)v8 + 2 * v11, v10); //原有上新增？
    v9 = *v4;
